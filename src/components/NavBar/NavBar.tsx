...
import './NavBar.scss';
import { AppUserContext, IUserState } from '../../classes/state/IAppState';
            ...
            (props: IUserState) => {
                return <header className="navbar navbar-expand navbar-dark flex-column flex-md-row bd-navbar">
                    ...
                    <ul className="navbar-nav ml-md-auto">
                        {props.isUserAuthenticated && <div className="navUserInfo">
                            <div className="userName">{props.userDisplayName}</div>
                            <div className="userMail">{props.userName}</div>
                        </div>
                        }
                    </ul>
                </header>
